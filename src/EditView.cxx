	...
	for (size_t r = 0; (r<model.sel.Count()) || drawDrag; r++) {
		...
		if (ll->InLine(offset, subLine) && offset <= ll->numCharsBeforeEOL) {
			...
			if ((xposCaret >= 0) && vsDraw.IsCaretVisible(mainCaret) &&
				...
				ColourRGBA caretColour = *vsDraw.ElementColour(elementCaret);
...
void EditView::DrawForeground(Surface *surface, const EditModel &model, const ViewStyle &vsDraw, const LineLayout *ll,
	Sci::Line line, Sci::Line lineVisible, PRectangle rcLine, Range lineRange, Sci::Position posLineStart, int xStart,
